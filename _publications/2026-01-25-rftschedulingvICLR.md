...
An earlier version of this work appeared at the [NeurIPS 2025 Reliable ML Workshop](https://reliablemlworkshop.github.io/) under the title "Robust Fine-Tuning from Non-Robust Pretrained Models: Mitigating Suboptimal Transfer With Adversarial Scheduling".

<figure>
  <img src="/images/publications/epsilon-scheduling.png" alt="Clean accuracy of Swin and ViT models fine-tuned with a robust objective, plotted against perturbation strength for five datasets. Accuracy degrades sharply as perturbation strength grows, by up to 76 points on Aircraft.">
  <figcaption>Fine-tuning non-robust pretrained models with a robust objective degrades clean accuracy far beyond what the perturbation strength should cost — <i>suboptimal transfer</i>. On harder datasets the drop is severe enough to count as transfer failure.</figcaption>
</figure>
