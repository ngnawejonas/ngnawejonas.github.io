...
<figure>
  <img src="/images/publications/robust-generalization-guide.png" alt="Scatter plot of average robust accuracy against average clean accuracy across training configurations, with marker shape, size, colour and outline encoding model type, model size, pre-training strategy and loss function.">
  <figcaption>1,440 training configurations across 6 datasets and 40 pretrained architectures, plotted as clean vs. robust accuracy. Marker shape, size, fill and outline encode architecture type, size, pre-training strategy and loss.</figcaption>
</figure>
